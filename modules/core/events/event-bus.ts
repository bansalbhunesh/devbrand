export type DomainEvent = 
  | { type: "TRANSFORM_STARTED"; payload: { userId: string; prUrl: string; jobId: string } }
  | { type: "TRANSFORM_COMPLETED"; payload: { userId: string; outputId: string; slug: string } }
  | { type: "TRANSFORM_FAILED"; payload: { userId: string; prUrl: string; error: string } }
  | { type: "ROAST_GENERATED"; payload: { userId: string; roastId: string } }
  | { type: "POST_SCHEDULED"; payload: { userId: string; scheduledPostId: string; channel: string } };
