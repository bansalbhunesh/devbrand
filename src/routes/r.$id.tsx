  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-red-500/30 p-6 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-3xl w-full relative z-10">
        ...
        <div className="p-12 md:p-20 rounded-[3rem] border border-white/5 bg-white/5 backdrop-blur-2xl relative group mb-16 shadow-2xl shadow-red-500/5 overflow-hidden">
           ...
           <div className="flex flex-wrap gap-12 items-end pt-12 border-t border-white/5">
              <div>
                <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-2">Technical Hubris</div>
                <div className="text-6xl font-black text-red-500 tracking-tighter">{roast_score}%</div>
              </div>
              <div>
                <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-2">Verdict</div>
                <div className="text-xl font-bold uppercase tracking-tight text-foreground/80">{criticality}</div>
              </div>
              <div className="ml-auto text-right hidden sm:block">
                 <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-2">Registry Hash</div>
                 <div className="text-[10px] font-mono opacity-20 hover:opacity-100 transition-opacity uppercase">{id}</div>
              </div>
           </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-12">
           <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              >
                <Twitter className="h-5 w-5" /> {posting ? "Broadcasting..." : "Broadcast to X"}
              </button>
              <a 
           ...
           <div className="flex flex-col items-center gap-6">
              ...
              >
                Get Roasted Yourself <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Link>
           </div>
        </div>
      </div>
      ...
      <footer className="absolute bottom-12 left-1/2 -translate-x-1/2 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/30">
        <ShieldCheck className="h-3 w-3" /> Proof of technical Hubris registered via DevBrand AI
      </footer>
    </div>
  );
}
