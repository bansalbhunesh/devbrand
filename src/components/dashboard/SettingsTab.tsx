    ...
    <div className="max-w-lg space-y-10 animate-in fade-in duration-500">
      <div>
        ...
        <div className="space-y-8">
          <div>
            <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground mb-4 block">Seniority level</label>
          ...
          <div>
            <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground mb-4 block">Writing tone</label>
          ...
          >
            {settingsSaving ? <Loader2 className="h-4 w-4 animate-spin" /> : <Check className="h-4 w-4 text-blue-500" />}
            Save configuration
          </button>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between p-6 rounded-2xl border border-border bg-muted/20">
          <div>
            ...
            <p className="text-[11px] text-muted-foreground mt-1 font-medium">
              {user.plan === "free" ? `${user.generationsThisMonth ?? 0}/3 generations used` : "Unlimited impact stories"}
            </p>
          </div>
          {user.plan === "free" ? (
            <button 
