        ...
        >
          ...
          <div className="relative rounded-2xl bg-background/40 backdrop-blur-2xl border border-border shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between px-5 py-3 border-b border-border bg-muted/40">
              ...
              <div className="text-[10px] font-mono text-muted-foreground/60 uppercase tracking-widest">devbrand.app/transform/9f2c</div>
              <button
              ...
              >
                {copied ? <><Check className="h-3 w-3 text-green-500" /> COPIED</> : <><Link2 className="h-3 w-3" /> SHARE</>}
              </button>
            </div>
            ...
            <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-border">
              ...
              <div className="p-8 md:p-10">
                <div className="flex items-center gap-2 text-xs text-muted-foreground mb-6">
                  ...
                  <span className="opacity-40">/</span>
                  <span className="text-[10px] font-bold bg-green-500/10 text-green-500 px-1.5 py-0.5 rounded">MERGED</span>
                </div>
                <div className="font-mono text-sm leading-8 text-foreground/80">
                  <span className="text-muted-foreground/60">msg</span> &nbsp;Fix retry on flaky txns<br />
                  <span className="text-green-500/90 font-bold">+428</span>{" "}
                  <span className="text-red-500/90 font-bold">−164</span> &nbsp;
                  <span className="text-[10px] uppercase font-bold text-muted-foreground/60">across 9 files</span>
                  <div className="mt-6 rounded-xl border border-border bg-muted/10 p-4 text-[12px] leading-7 font-medium">
                    <span className="text-green-500 font-bold">+ </span>retry with jittered exp backoff<br />
                    <span className="text-green-500 font-bold">+ </span>idempotency key per attempt<br />
                    <span className="text-green-500 font-bold">+ </span>circuit breaker around payments<br />
                    <span className="text-red-500 font-bold">− </span>blocking sync wait loop
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 md:p-10 bg-blue-500/5">
                <div className="flex items-center gap-2 text-xs text-muted-foreground mb-6">
                  ...
                  <span className="font-bold uppercase tracking-widest text-[10px]">Intelligence Output</span>
                  <span className="ml-auto text-[10px] font-mono opacity-50">claude-3-5 · 1.2s</span>
                </div>
                ...
                <div className="mt-8 rounded-xl border border-border bg-background/50 p-4">
                  <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-muted-foreground mb-3">Verifiable Evidence</div>
...
function Cite({ n, children }: { n: number; children: React.ReactNode }) {
  return (
    <span className="relative">
      ...
      <sup className="ml-1 text-[10px] font-mono font-bold text-blue-500">[{n}]</sup>
    </span>
  );
}
