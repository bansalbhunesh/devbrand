...
export function Roast() {
  ...
  const handleRoast = async () => {
    ...
    try {
      ...
      console.error(err);
      setError(err.message.includes("LIMIT_REACHED") 
      ...
      <div className="mx-auto max-w-7xl px-6 relative">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight mb-8">Roast a Sacrifice.</h2>
            <p className="text-muted-foreground text-lg leading-relaxed mb-10">
              Our AI doesn't just summarize work — it judges it. Roast yourself, your lead, or that 
              one friend who still uses `var`. Precision-engineered insults backed by real GitHub data.
            </p>
          ...
          <div className="relative">
            ...
            <motion.div 
              ...
              className={cn(
                ...
                roastData?.criticality === 'NUCLEAR' ? "bg-red-500/10 border-red-500/40 shadow-red-500/20" : "bg-muted/20"
              )}
            >
                ...
                <div className="flex items-center justify-between mb-8 border-b border-border pb-6">
                  <div className="flex items-center gap-3">
                    <div className={cn(
                      ...
                      loading ? "bg-yellow-500" : roastData ? "bg-red-500" : "bg-muted-foreground/30"
                    )} />
                    ...
                    {loading ? (
                      ...
                      >
                        ...
                        <div className="space-y-2 text-center">
                          <p className="font-bold tracking-[0.2em] text-[10px] uppercase text-foreground">Analyzing Reputation...</p>
                          <p className="text-[10px] opacity-40 animate-pulse">{scanLogs[scanStep]}</p>
                        </div>
                      </motion.div>
                    ) : roastData ? (
                      <motion.div 
                        ...
                        className="space-y-8"
                      >
                        <motion.div variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 } }} className="flex items-center justify-between">
                          <div>
                        ...
                        <motion.p variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }} className="text-foreground text-base leading-relaxed italic border-l-2 border-red-500/20 pl-6 py-2">
                          "{roastData.roast}"
                        </motion.p>
                        ...
                        <motion.div variants={{ hidden: { opacity: 0, scale: 0.9 }, visible: { opacity: 1, scale: 1 } }} className="p-4 rounded-xl border border-blue-500/10 bg-blue-500/5">
                ...
                {roastData && (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-[9px] font-bold text-red-500 tracking-[0.3em] animate-pulse uppercase">Live Data</span>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                      ...
                      >
                        <Share2 className="h-3.5 w-3.5 group-hover:scale-110 transition" /> LinkedIn
                      </a>
                      <a 
                      ...
                      >
                        <Flame className="h-3.5 w-3.5 group-hover:animate-bounce" /> Tag them
                      </a>
                      <button 
                        onClick={() => {
