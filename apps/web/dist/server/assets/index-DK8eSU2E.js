...
import { Github, Twitter, Linkedin, Gavel, ArrowRight, Flame, CheckCircle2, Copy } from "lucide-react";
...
const generatePost = createServerFn("POST", async (prUrl) => {
  ...
  const truncatedDiff = diffText.length > 2e4 ? diffText.slice(0, 2e4) + "\n...[DIFF TRUNCATED]..." : diffText;
